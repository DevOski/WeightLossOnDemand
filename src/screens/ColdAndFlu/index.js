      ...
      <ScrollView style={styles.color}>
        ...
        <View style={styles.padding}>
          <Text style={styles.textColor}>
            ...
            season, Weight Loss On Demand makes it easy to get the care you need to
            feel better fast.
          </Text>
        </View>
        <View style={styles.padding}>
          ...
          <View style={[styles.paddingTop, styles.paddingBottom]}>
            ...
            <View style={styles.paddingTop}>
              <Text style={styles.textColor}>
                Weight Loss On Demand lets you skip the waiting room, and get the
                treatment you need in minutes. This cold and flu season, meeting
                with one of our doctors is the smartest way to get back on your
                feet.
              </Text>
            </View>
          </View>
